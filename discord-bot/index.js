  ...
  */
  ...
  if (message.content.startsWith('/setsteam')) {
    ...
    if (!steamProfile) {
      ...
      await message.reply(
        '❌ Uso correcto: `/setsteam <steam_profile>`'
      );
  ...
  if (message.content === '/lobby') {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setTitle(
          '🥊 Lobby de Ultra Street Fighter IV'
        )
        ...
        .setAuthor({
          ...
          name:
            `${message.author.username} creó el lobby`,
        ...
        .setFooter({
          ...
          text:
            'SF4 Tournament Bot • Ultra Street Fighter IV',
      ...
      await message.reply(
        '❌ Error comunicándose con la API.'
      );
...
app.get("/", (req, res) => {
  ...
  res.send(
    "🍔 Chun-Burger está despierto y listo para luchar! 🥊"
  );
